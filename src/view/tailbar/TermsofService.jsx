const TermsofService = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to WinPick.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to WinPick, accessible from{" "}
            <a
              href="https://cooperative-worldmodels.site/"
              rel="external nofollow noopener"
            >
              https://cooperative-worldmodels.site/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: jooyeon.kim@unist.ac.kr</li>
      </ul>
    </div>
  );
};
